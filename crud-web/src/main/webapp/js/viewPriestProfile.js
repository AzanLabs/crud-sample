	...
	init : function(){
		...
		var viewProfileHTML = '<div>'
								  ...
								  +'<div style="margin-top:10px;">'
										+'<button type="button" class="btn btn-default viewUserDetails" style="width:70%;" name="user2">User 2</button><a href="javascript:void(0);" class="deletedICON" style="margin-left:10px;margin-right:10px;"><span class="glyphicon glyphicon-trash"></span></a>'
								  +'</div>'
